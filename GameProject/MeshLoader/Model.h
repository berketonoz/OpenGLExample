...
public:
    ...
    vector<float> GetMins(){
        return this->mins;
    }
    vector<float> GetMaxs(){
        return this->maxs;
    }
...
//        std::cout << vertices.size() << std::endl;
        ...
        if( mesh->mMaterialIndex >= 0 )
        {
            ...
            // 1. Diffuse maps
            vector<Texture> diffuseMaps = this->loadMaterialTextures( material, aiTextureType_DIFFUSE, "material.diffuse" );
            textures.insert( textures.end( ), diffuseMaps.begin( ), diffuseMaps.end( ) );
            
            // 2. Specular maps
            vector<Texture> specularMaps = this->loadMaterialTextures( material, aiTextureType_SPECULAR, "material.specular" );
...
//                std::cout << texture.id << " " << this->directory << std::endl;
